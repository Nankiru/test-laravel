          ...
          @foreach ($users as $user)
            @if ($user->name != 'Laravel 12')
              <div class="col-sm-6 col-xl-3 mb-4">
                <div class="card overflow-hidden rounded-2 h-100 d-flex flex-column">
                  <div class="position-relative">
                    <a href="javascript:void(0)">
                      <img src="{{ url('uploads/'.$user->img) }}" class="w-100" style="height: 200px; object-fit: cover;" alt="#">
                    </a>
                    <a href="javascript:void(0)"
                  ...
                  <div class="card-body pt-3 p-4 d-flex flex-column">
                    ...
                    <div class=" d-flex align-items-center justify-content-between">
                      <span class="fs-4 mb-0 fw-normal text-muted">{{ $user->position }} 
