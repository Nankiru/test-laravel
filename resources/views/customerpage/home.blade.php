    ...
    <header class="w-full bg-gray-300 px-5 py-2 lg:border-none border-b border-pink-400">
        <nav class="flex items-center justify-between">
            <a href="/">
                ...
                <img src="{{ asset('uploads/'.session('img')) }}" alt="Laravel Logo" class="w-10 h-10">
            </a>

            <!-- Desktop Menu -->
            <div class="hidden lg:block">
                <ul class="flex items-center justify-between gap-2">
                    <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Home</a>
                    </li>
                    <li><a href=""
                            class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Products</a></li>
                    <li><a href=""
                            class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Services</a></li>
                    <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">About
                            Us</a></li>
                    <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Contact</a>
                    </li>
                </ul>
            </div>
            ...
            @if (session()->has('id'))
                ...
                <form action="{{ url('user_logout') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="hidden lg:block bg-red-500 text-white px-3 py-2 rounded-lg hover:text-gray-300 transition duration-300">
                        Logout
                    </button>
                </form>
            @else
                ...
                <a href="{{ url('login') }}">
                    <button
                        class="hidden lg:block bg-pink-500 text-white px-3 py-2 rounded-lg hover:text-gray-300 transition duration-300">
                        Login Now
                    </button>
                </a>
            @endif
        ...
        <div id="mobileMenu" class="hidden flex flex-col bg-gray-300 px-5 py-4 lg:hidden">
            <ul class="flex flex-col gap-3">
                ...
                <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Products</a>
                </li>
                <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Services</a>
                </li>
                <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">About Us</a>
                </li>
                <li><a href="" class="text-lg text-pink-500 hover:text-pink-600 transition duration-500">Contact</a>
                </li>
            </ul>
            ...
            {{-- <button
                class="bg-pink-500 text-white px-3 py-2 rounded-lg hover:text-gray-300 transition duration-300 mt-3">
                <a href="">Login Now</a>
            </button> --}}
            <!-- Show Logout button if user is logged in -->
            @if (session()->has('id'))
                ...
                <article class="rounded-xl border-2 border-gray-100 bg-white">
                    <div class="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
                        <a href="#" class="block shrink-0">
                            <img alt="" src="{{asset('uploads/' . $user->img)}}" class="size-14 rounded-lg object-cover" />
                        </a>
