    ...
    <div class="row no-gutters">
        <div class="col-md-8">
            <div class="product-details mr-2">
                <a href="{{url('index')}}" class="d-flex flex-row align-items-center text-decoration-none"><i class="fa fa-long-arrow-left"></i><span
            ...
            <div class="d-flex justify-content-between">
                ...
                {{-- <div class="d-flex flex-row align-items-center">
                    ...
                    <div class="ml-2">
                        <select id="sortBy" class="form-control" style="width: 120px;">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                <div class="d-flex flex-row">
                    <img class="rounded" src="{{ asset('uploads/products/galaries/' . $item['image']) }}" width="40" alt="Product Image">
                    <div class="ml-2">
                ...
                <div class="d-flex flex-row align-items-center justify-content-center">
                    ...
                    <a href="javascript:void(0)" class="remove-item ml-3 text-black-50" data-id="{{ $id }}">
        ...
        <form action="" class="col-md-4" method="POST">
            ...
            <div class="payment-info">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="card_name" class="form-control credit-inputs" placeholder="Name" required>
                </div>
        
                <div>
                    <label class="credit-card-label">Card number</label>
                    <input type="text" name="card_number" class="form-control credit-inputs" placeholder="0000 0000 0000 0000" required>
                </div>
        
                <div class="row">
                    <div class="col-md-6">
                        <label class="credit-card-label">Expiry Date</label>
                        <input type="text" name="expiry_date" class="form-control credit-inputs" placeholder="MM/YY" required>
                    </div>
                    <div class="col-md-6">
                        <label class="credit-card-label">CVV</label>
                        <input type="text" name="cvv" class="form-control credit-inputs" placeholder="123" required>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary btn-block d-flex justify-content-between mt-3">
                    <span>${{ number_format(($subtotal ?? 0) + ($shipping ?? 20.00), 2) }}</span>
